...
| D         | good commit      | 4 days ago |

We are going to squash A over top of B & C, keeping only D and A.

(2)
put cursor on D, the older good commit, and rebase interactive with: 

: r i

You will now get them flipped around (chronologically)

| action | commit ID | comment          | when       |
| pick   | D         | good commit      | 4 days ago |
| pick   | C         | bad commit       | 3 days ago |
| pick   | B         | very bad commit  | 2 days ago |
| pick   | A         | very good commit | 1 days ago |

So we want to keep A & D, so we set B, & C to get squashed.
So the table should now look like:
...
To proceed with the squashing!

LOG
bd919b8 * master good 2
d2689eb * good commit
5ea3c7c * a good commit 2
c00a1c0 * a good commit 1
