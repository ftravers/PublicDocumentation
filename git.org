...
Save your work to the stash

: git stash

Show whats in the stash queue

: git stash list

Make a branch from your stash
...
See which files differ from branch and master

: git diff --name-status master..<branch_name>

Diff files on branch with master

: git diff <branch_name> master -- <file_name>
