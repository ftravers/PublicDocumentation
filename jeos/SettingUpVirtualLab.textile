...
* We can name this template after the size of the system disk we will allocate to it and the OS it will be running.  Lets choose: @sys6gb_swp1gb_oel5u5@, meaning we'll assign a 6144MB system disk and install OEL(Oracle Enterprise Linux) 5 update 5 into it.
