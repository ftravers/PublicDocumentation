...
three files: named.conf and <forward and reverse zone files>.  
...
So our first file will look like:
...
p. Zone file example: /var/named/chroot/var/named/githklab.zone
...
p. Zone file example: /var/named/chroot/var/named/githklab.rev.zone
