...
* Setup an "SSH trust":/ssh.html#sshAutoLogin
...
Your terminal session should die here and you can now setup a new "SSH trust":/ssh.html#sshAutoLogin, as trusts are based on IP addresses and you've changed IP Address.
