...
Netbeans has good support for JSF 2.x so I recommend using it.

h2. pom.xml

Remove the junit dependency and add the javaee-web-api dependency V6.0:
bc. 
...
update: @Web Pages/WEB-INF/web.xml@, the following can serve as a basic model.
...
Run it and check it out: @http://localhost:8080/SSP/index.html@
...
bc. [localePrefix/][libraryName/][libraryVersion/]resourceName[/resourceVersion]
...
bc. <h:outputStylesheet name="style.css" library="css" />
