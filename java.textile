...
To see the memory profile of a running java process...can use VisualVM.
...
Config files: logback.xml:  You use this for production.  Notice there
...
There may be information that is specific to the environment you are
...
bc. ./jstatd -J-Djava.security.policy=jstatd.all.policy &
