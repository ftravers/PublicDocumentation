...
Change the groupId and artifactId to be what you want your archetype
to be called.  Start creating your archetype with the following
command:

bc. mvn archetype:create -DgroupId=com.oracle.git -DartifactId=addTesting-archetype -DarchetypeArtifactId=maven-archetype-archetype
...
it should be modified to look something like:

bc. 
$ cd addTesting-archetype;cat > src/main/resources/archetype-resources/pom.xml
...
hit Ctrl-d to finish the @cat@ command.  Next run:

bc. mvn install

Then you can build a new project based on this archetype by doing the
following:

bc. mvn archetype:generate -B -DarchetypeGroupId=com.oracle.git -DarchetypeArtifactId=addTesting-archetype -DarchetypeVersion=1.0-SNAPSHOT -Dversion=0.0.1 -DgroupId=com.acme -DartifactId=testProject -Dpackage=com.acme.testProject
