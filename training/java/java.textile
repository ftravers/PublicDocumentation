...
Often you need to load values from a properties file.  The best way to do this is to put the properties files into your classpath somewhere and access it like:
...
In the above scenario this would be located at: @some/pkg/resource.properties@.  Then you'd jar up your sources, including the resource.properties file and your code would still work when deployed in different scenarios.
