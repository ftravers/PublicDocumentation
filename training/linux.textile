...
Others = All white
*** Bindings
Move Up/Down/Next/Prev = Ctrl-Alt - i/,/l/j
...
* Package Manager = texlive-full, emacs, clisp, slime, latexdiff, git-core, git-gui, gitosis, gitweb, ant, maven, pidgin, meld, apache2, auctex, libtiff-tools, openoffice.org, transmission, cups-pdf, gimp, xmlcopy, shutter
...
* Under ‘Wireless’, highlight your wireless connection and click on ‘Edit’.
...
Notifications: In Pidgin, go to Tools > Plugins and select Libnotify and then click Configure Plugin and uncheck what you don't want.
