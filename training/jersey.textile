...
# Note your 'Rest Resources Path': resources
...
bc. http://localhost:8080/crmodRestServer4/resources/Autosr
...
In netbeans goto: view > servers > select your glassfish server there
> location.

h4. webapp 

The web app will be the name of the folder you are doing your
development in

h4. resource 

 the next part comes from looking at the url-pattern for the
Jersey servlet in @src/main/webapp/WEB-INF/web.xml@
...
h3. Deployed to app server as *.war

h4. port

bc. grep network-listener /home/oracle/bin/glassfishv3/glassfish/domains/domain1/config/domain.xml

h4. webapp

This will be the name of the war file that gets deployed.  Or

bc. /src/main/webapp/WEB-INF/sun-web.xml:  <context-root>/SES</context-root>
