...
setup start/stop scripts here: 
http://download.oracle.com/docs/cd/B28359_01/server.111/b32009/strt_stp.htm#CEGHJACG

==> stop / start Database
	STOP:
	To identify the SID and Oracle home directory for the instance that you want to shut down...
		$ cat /etc/oratab
...
==> BACKUP THE DATABASE:
	Export a dump
		-bash-3.2$ expdp idc_user/idc_user@127.0.0.1 schemas=idc_user directory=datapumpdir dumpfile=ucm.dmp logfile=log.dmp
