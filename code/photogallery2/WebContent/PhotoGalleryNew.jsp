...
<script>
	...
	<%for(Photo photo : pictures) {%>
		...
		photoList[counter].author = "<%=photo.getAuthor() %>";
		counter++;
<%}%>
</script>
...
<%for(Photo photo : pictures) {%>
	...
	<div class="image-desc">Description : <%=photo.getComments() %></div>
	<div class="image-desc">Author : <%=photo.getAuthor() %></div>
