...
public class _DocGuidedSearchPage extends com.orionserver.http.OrionHttpJspPage {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response) throws java.io.IOException, ServletException {
    ...
    */
    ...
    _DocGuidedSearchPage page = this;
    ...
    try {
      ...
      out.write(__oracle_jsp_text[6]);
          ...
          // create home page for this portlet
          PortletURL homeURL = renderResponse.createActionURL();
          homeURL.setParameter("isGuided","no");
      
      out.write(__oracle_jsp_text[7]);
      out.print(homeURL.toString());
      out.write(__oracle_jsp_text[8]);
      	...
      	SearchResultsBuilder srb = new SearchResultsBuilder();
              ...
              DocSearchResults docSearchResults = srb.getDocumentSearchResults(application,username,category,categoryType,searchText,prevPage,pageSize);
      ...
      out.write(__oracle_jsp_text[9]);
          ...
          int totalRows =	docSearchResults.getTotalRows();
      ...
      out.print(docSearchResults.getTotalRows());
      ...
      for(SearchResult searchResult : docSearchResults.getDocSearchResults()) {
